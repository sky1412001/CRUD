...
var InputGroup = /** @class */ (function (_super) {
    ...
    InputGroup.prototype.render = function () {
        ...
        var inputProps = tslib_1.__assign(tslib_1.__assign({ type: "text" }, (0, props_1.removeNonHTMLProps)(this.props, NON_HTML_PROPS, true)), { className: (0, classnames_1.default)(common_1.Classes.INPUT, inputClassName), onChange: this.handleInputChange, style: style });
