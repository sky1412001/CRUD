...
var TextArea = /** @class */ (function (_super) {
    ...
    TextArea.prototype.render = function () {
        var _a;
        // eslint-disable-next-line deprecation/deprecation
        var _b = this.props, autoResize = _b.autoResize, className = _b.className, fill = _b.fill, growVertically = _b.growVertically, inputRef = _b.inputRef, intent = _b.intent, large = _b.large, small = _b.small, htmlProps = tslib_1.__rest(_b, ["autoResize", "className", "fill", "growVertically", "inputRef", "intent", "large", "small"]);
