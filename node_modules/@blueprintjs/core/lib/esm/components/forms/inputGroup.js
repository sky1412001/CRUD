...
var InputGroup = /** @class */ (function (_super) {
    ...
    InputGroup.prototype.render = function () {
        ...
        var inputProps = __assign(__assign({ type: "text" }, removeNonHTMLProps(this.props, NON_HTML_PROPS, true)), { className: classNames(Classes.INPUT, inputClassName), onChange: this.handleInputChange, style: style });
